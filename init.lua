...
-- Diagnostic keymaps
-- Disabled. using trouble plugin. vim.keymap.set('n', '<leader>q', vim.diagnostic.setloclist, { desc = '[Q]uickfix list' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>st', builtin.filetypes, { desc = 'in File [T]ype' })
      vim.keymap.set('n', '<leader>sk', builtin.keymaps, { desc = '[K]eymaps' })
      vim.keymap.set('n', '<leader>sf', builtin.find_files, { desc = '[F]ile' })
      vim.keymap.set('n', '<leader>so', builtin.builtin, { desc = 'All Telescope Search [O]ptions' })
      ...
      vim.keymap.set('n', '<leader>sl', builtin.oldfiles, { desc = 'in [L]atest Files' })
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>ss', require('telescope.builtin').lsp_document_symbols, '[S]ymbols')

          -- Fuzzy find all the symbols in your current workspace.
          --  Similar to document symbols, except searches over your entire project.
          --          map('<leader>cS', require('telescope.builtin').lsp_dynamic_workspace_symbols, '[S]ymbols Workspace')
